...
CREATE TABLE `maderas_datos` (
  ...
  `phone` varchar(10) COLLATE utf8mb3_spanish2_ci DEFAULT NULL,
  `security_question` varchar(255) COLLATE utf8mb3_spanish2_ci DEFAULT NULL,
  `security_answer` varchar(255) COLLATE utf8mb3_spanish2_ci DEFAULT NULL,
  `recovery_email` varchar(254) COLLATE utf8mb3_spanish2_ci DEFAULT NULL,
  `status` varchar(20) COLLATE utf8mb3_spanish2_ci NOT NULL,
  `is_active` tinyint(1) NOT NULL,
  `is_staff` tinyint(1) NOT NULL,
  `profile_image` varchar(100) COLLATE utf8mb3_spanish2_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `maderas_datos` VALUES (1,'pbkdf2_sha256$870000$Je92LLihPEx0CQvvdlDwDO$OIWZKZ5cGcmzhf8Q5kK8HNaltLJSN9HgmIsWAYEewrI=','2025-05-09 14:18:10.750931',0,'krotinxremaster@gmail.com','yahir','palacios','3134337180','ciudad_nacimiento','sogamoso','cyahirpalacios@gmail.com','Activo',1,0,'profile_images/avatar_zI4RABD.png');
...
CREATE TABLE `maderas_document` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `file` varchar(100) COLLATE utf8mb3_spanish2_ci DEFAULT NULL,
...
CREATE TABLE `maderas_folder` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb3_spanish2_ci NOT NULL,
  `status` varchar(50) COLLATE utf8mb3_spanish2_ci NOT NULL,
  `fecha_inicio` varchar(100) COLLATE utf8mb3_spanish2_ci DEFAULT NULL,
  `puesto_designado` varchar(255) COLLATE utf8mb3_spanish2_ci DEFAULT NULL,
  `salario_actual` varchar(100) COLLATE utf8mb3_spanish2_ci DEFAULT NULL,
  `horas_trabajo` varchar(50) COLLATE utf8mb3_spanish2_ci DEFAULT NULL,
  `tiempo_contrato` varchar(100) COLLATE utf8mb3_spanish2_ci DEFAULT NULL,
  `numero_identidad` varchar(100) COLLATE utf8mb3_spanish2_ci DEFAULT NULL,
  `numero_seguro_social` varchar(100) COLLATE utf8mb3_spanish2_ci DEFAULT NULL,
  `eps` varchar(100) COLLATE utf8mb3_spanish2_ci DEFAULT NULL,
  `fondo_pensiones` varchar(100) COLLATE utf8mb3_spanish2_ci DEFAULT NULL,
  `arl` varchar(100) COLLATE utf8mb3_spanish2_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `maderas_folder` VALUES (1,'yahir','Incapacitado','','','','','','','','','',''),(2,'stiven','No definido',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `maderas_product` (
  ...
  `wood_type` varchar(100) COLLATE utf8mb3_spanish2_ci NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `maderas_producto` (
  ...
  `nombre_producto` varchar(200) COLLATE utf8mb3_spanish2_ci NOT NULL,
...
INSERT INTO `maderas_producto` VALUES (1,1,'sdfdsfds','adsfdsfdsfds','productos/๑Akatsuki___ui0IMQW.jpeg',1,2000.00);
...
INSERT INTO `maderas_tipomadera` VALUES (1,'Pino');
...
-- Dump completed on 2025-05-09  9:22:44
